...
<div id="modify-account">
    <h3 class="text-center text-white pt-5">modify account form</h3>
    <div class="container">
        <div id="modify-account-row" class="row justify-content-center align-items-center">
            <div id="modify-account-column" class="col-md-6">
                <div id="modify-account-box" class="col-md-12">
                    <form id="modify-account-form" class="form" action="" method="get">
                        <h3 class="text-center text-info">Modify Account</h3>
                        <div class="form-group">
                            <label for="newUsername" class="text-info">Enter a new username:</label><br>
